...
We have two categories of weight matrices - *U* parameterizes the transformation of input *X* and *W*, the transformation of previous state. We define tensors *U* and *W* that contain $$U^z, U^r, U^h$$ and $$W^z, W^r, W^h$$ respectively, along with a bias *b*. 
...
The parameters *U* and *W* are defined below.
